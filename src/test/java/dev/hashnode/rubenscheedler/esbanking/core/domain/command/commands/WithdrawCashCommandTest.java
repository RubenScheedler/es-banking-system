...
class WithdrawCashCommandTest {
    @Test
    void withdrawCashCommand_cantBeCreatedWithoutAccount() {
        assertThatThrownBy(() -> WithdrawCashCommand.builder()
    ...
    @Test
    void withdrawCashCommand_cantBeCreatedWithoutAmount() {
        assertThatThrownBy(() -> WithdrawCashCommand.builder()
